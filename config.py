...
WEBHOOK_SSL_CERT = '/home/gorec/test/db_and_certs/webhook_cert.pem'  # Path to the ssl certificate
WEBHOOK_SSL_PRIV = '/home/gorec/test/db_and_certs/webhook_pkey.pem' # Path to the ssl private key

WEBHOOK_URL_BASE = "https://%s:%s" % (WEBHOOK_HOST, WEBHOOK_PORT)
WEBHOOK_URL_PATH = "/%s/" % (API_TOKEN)

DB = "/home/gorec/test/db_and_certs/Shefflera.db"
